...
var Resource = function(options) {
  _.defaults(options, {
    actions: ['create', 'read', 'update', 'delete', 'list', 'swag', 'count'],
    pagination: true,
  ...
  this.endpoints = {
    ...
    swag: options.endpoints[2] || ["","swag", options.endpoints[0].slice(1)].join("/"),
    count: options.endpoints[3] || ["","count", options.endpoints[0].slice(1)].join("/"),
  };
